...
from infer_yolo_v10.infer_yolo_v10_process import InferYoloV10Param
...
# --------------------
class InferYoloV10Widget(core.CWorkflowTaskWidget):

    def __init__(self, param, parent):
        core.CWorkflowTaskWidget.__init__(self, parent)

        if param is None:
            self.parameters = InferYoloV10Param()
        else:
